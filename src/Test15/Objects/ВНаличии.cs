...
namespace IIS.Test15
{
    ...
    public class ВНаличии : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Test15.Товары.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВНаличииE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВНаличииE", typeof(IIS.Test15.ВНаличии));
                }
            }
        }
    }
    ...
    public class DetailArrayOfВНаличии : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Test15.DetailArrayOfВНаличии members)

        // *** End programmer edit section *** (IIS.Test15.DetailArrayOfВНаличии members)
        ...
        /// </summary>
        public DetailArrayOfВНаличии(IIS.Test15.Товары fТовары) : 
                base(typeof(ВНаличии), ((ICSSoft.STORMNET.DataObject)(fТовары)))
        {
        }
        
        public IIS.Test15.ВНаличии this[int index]
        {
            get
            {
                return ((IIS.Test15.ВНаличии)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Test15.ВНаличии dataobject)
        {
